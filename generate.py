...
def generate(ticker, tax_rate, num_years, growth_rate, std_dev, gross_margin_avg, operating_margin_avg, simulations, pe_ratio, discount_rate):
  ...
  return monteCarlo.simulate(pe_ratio, discount_rate)
